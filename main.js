...
// تابع چاپ رسید با صفحه جداگانه
function printReceipt(studentName, studentFather, studentCardId, totalFee, paidFee, remainingFee, paymentAmount, paymentDate, expiryDate, receiptNumber, notes, className = '') {
    // ساخت URL با پارامترها
    const params = new URLSearchParams();
    params.append('student_name', studentName || '');
    params.append('student_father', studentFather || '');
