...
// تابع کمکی برای تبدیل undefined به null
...
app.put("/api/students/:id", authenticate, upload.single("photo"), async (req, res) => {
    ...
    let values = [name, toNull(father_name), toNull(phone), class_id, finalTotalFee, finalPaidFee, finalRemainingFee, finalDueDate, status, toNull(address)];
